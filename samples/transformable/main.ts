...
let transformable: Ui.Transformable;
...
// x = 0 and y = 0.
//
function onRotateScaleTransform(transformable: Ui.Transformable) {
...
//
function onLimitedScaleTransform(transformable: Ui.Transformable) {
...
//
function onStepRotateTransform(transformable: Ui.Transformable) {
